                ...
                <div className='flex flex-col lg:flex-row gap-6 justify-between items-center mx-auto'>
                    <div className='flex flex-col justify-center items-start w-auto lg:w-3xl'>
                        ...
                        <div className="mt-6 flex justify-center gap-4">
                            ...
                            <Link to='https://wa.me/6285282932422' target='_blank' className="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden rounded-full font-semibold text-blue-600 transition-all duration-150 ease-in-out hover:pl-10 hover:pr-6 bg-transparent group">
